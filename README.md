...
ns-flip/2.4.5 linux-x64 node-v14.9.0
$ ns --help [COMMAND]
USAGE
  $ ns COMMAND
...
...
_See code: [lib/commands/check.js](https://github.com/NoStackApp/ns-flip/blob/v2.4.5/lib/commands/check.js)_
...
_See code: [lib/commands/contact.js](https://github.com/NoStackApp/ns-flip/blob/v2.4.5/lib/commands/contact.js)_
...
_See code: [lib/commands/filediffs.js](https://github.com/NoStackApp/ns-flip/blob/v2.4.5/lib/commands/filediffs.js)_
...
_See code: [lib/commands/generate.js](https://github.com/NoStackApp/ns-flip/blob/v2.4.5/lib/commands/generate.js)_
...
_See code: [lib/commands/newtemplate.js](https://github.com/NoStackApp/ns-flip/blob/v2.4.5/lib/commands/newtemplate.js)_
...
_See code: [lib/commands/settings.js](https://github.com/NoStackApp/ns-flip/blob/v2.4.5/lib/commands/settings.js)_
<!-- commandsstop -->
