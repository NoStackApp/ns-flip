...
ns-flip/1.0.2 linux-x64 node-v14.9.0
$ ns --help [COMMAND]
USAGE
  $ ns COMMAND
...
...
_See code: [src/commands/generate.ts](https://github.com/NoStackApp/ns-flip/blob/v1.0.2/src/commands/generate.ts)_
...
_See code: [src/commands/newcode.ts](https://github.com/NoStackApp/ns-flip/blob/v1.0.2/src/commands/newcode.ts)_
...
_See code: [src/commands/newstarter.ts](https://github.com/NoStackApp/ns-flip/blob/v1.0.2/src/commands/newstarter.ts)_
...
_See code: [src/commands/test.ts](https://github.com/NoStackApp/ns-flip/blob/v1.0.2/src/commands/test.ts)_
<!-- commandsstop -->
